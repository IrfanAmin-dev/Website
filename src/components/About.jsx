                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            Bachelors in cyber yaydayadyuayddddddddddd ddddddddddddddddddddd ddddddddddddddddddddd ddddddddd
                        </p>

                        <p className="text-muted-foreground">
                            super awesome swag money cash moneyddddd dddddddddddddddd ddddddddddddddddddddddddd dddddddddddddddddddddd
                        </p>
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                        Creating secure applications and offensive malware
                                    </p>
                                </div>
                            </div>
                        </div>
